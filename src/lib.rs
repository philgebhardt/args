...
//! that requires a positive number of iteratiosn to be specified, and accepts an
//! optional log file name and a help flag.
//!
//! ```{.rust}
//! extern crate args;
...
//!     }
//!
//!     match args.validated_value_of("iter", &[Box::new(OrderValidation::new(Order::GreaterThan, 0u32))]) {
//!         Ok(iterations) => {
